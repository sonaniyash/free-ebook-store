...
const interDownload = InterstitialAd.createForAdRequest(GOOGLE_ADMOB.Interstitial, {
  requestNonPersonalizedAdsOnly: true,
  keywords: ['book', 'fashion', 'clothing'],
});
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView>
        ...
        <View style={{margin: 10}}>
          <Text
            style={{fontSize: 16, fontFamily: 'Ubuntu-Bold', color: '#4267B2', marginBottom: 10}}>
          ...
          />
          <Text style={{fontSize: 16, fontFamily: 'Ubuntu-Regular', marginTop: 5}}>
